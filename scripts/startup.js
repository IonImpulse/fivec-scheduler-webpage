...
async function startup() {
    ...
    desc_worker = new Worker('scripts/workers/descriptions.js?v=1.10.10');
    searcher_worker = new Worker('scripts/workers/searcher.js?v=1.10.0');
	searching_worker = new Worker('scripts/workers/courseSearch.js?v=1.10.8');
